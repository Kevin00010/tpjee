			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link " href="domaines.html"> <span
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link active" href="auteurs.html"> <span
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link " href="maisonEdition.html"> <span
								class="nav-icon"> <svg width="1em" height="1em"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">Ajouter un
									auteur</h5>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn app-btn-primary">Enregistrer</button>
							</div>
						</div>
					</div>
				</div>
											...
											<c:forEach var="auteur" items="${ auteurs }">
												<tr>
													...
													<td class="cell"><a class="btn-sm app-btn-secondary"
														href="editAuteur?id=<c:out value='${auteur.id}'/>">Modifier</a>
													<td class="cell"><a class="btn-sm app-btn-secondary"
														href="deleleAuteur?id=<c:out value='${auteur.id}'/>">Supprimer</a></td>
												</tr>
											</c:forEach>
