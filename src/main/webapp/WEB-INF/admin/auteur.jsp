	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form class="settings-form" method="post" action="insert_auteur">

									<div class="mb-3">
										<div class="row">
											<div class="col-6">
												<label for="setting-input-2" class="form-label">First
													name</label> <input type="text" class="form-control"
													id="setting-input-2" name="nom" required>
											</div>
											<div class="col-6">
												<label for="setting-input-2" class="form-label">Last
													name</label> <input type="text" class="form-control"
													id="setting-input-2" name="prenom" required>
											</div>
										</div>
									</div>
				...
				<!--  Auteur Table -->
				<div class="<c:out value="${ color}" />" role="<c:out value="${role}" />">
 						 <c:out value="${ message }" />
				</div>
							...
							<div class="app-card-body">
								...
								<div class="card">
									<div class="card-header">
										<div class="col-auto">
											<h1 class="app-page-title mb-0">Authors</h1>
										</div>
									</div>
									<div class="card-body">
												...
												<c:forEach var="auteur" items="${ auteurs }">
													<tr>
														...
														<td class="cell"><a class="btn-sm "
															...
															href="<c:url value='edit_auteur?id=${auteur.id}'/>"><i
																class="material-icons" data-toggle="tooltip"
																title="Edit">&#xE254;</i></a> 
															<a class="btn-sm " onclick="return confirm('Are you sure you want to delete this item?');"
															style="color: red"
															href="<c:url value='delete_auteur?id=${auteur.id}'/>"><span><i
																	class="material-icons" data-toggle="tooltip"
