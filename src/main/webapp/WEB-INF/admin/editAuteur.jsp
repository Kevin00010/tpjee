...
<!-- FontAwesome JS-->
<script defer><%@include file="/resources/assets/plugins/fontawesome/js/all.min.js"%>
	
</script>

<!-- App CSS -->
<style>
<%@ include file="/resources/assets/css/portal.css"%>
</style>
</head>
...
<body class="app">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<div class="app-branding">
					<a class="app-logo" href="index.html"><img
						...
						alt="logo"><span class="logo-text">My Docs</span></a>
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="list_document"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link " href="list_domaine"> <span
							...
							</span> <span class="nav-link-text">Domaines</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link active" href="list_auteur"> <span
							...
							</span> <span class="nav-link-text">Auteurs</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link " href="list_maison_edition"> <span
								class="nav-icon"> <svg width="1em" height="1em"
							...
							</span> <span class="nav-link-text">Maison Edition</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
					</ul>
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				<div class="row g-3 mb-4 align-items-center justify-content-between">
					<div class="col-auto">
						<h1 class="app-page-title mb-0">Auteurs</h1>
					</div>
					<div class="col-auto">
								...
								<form class="settings-form" method="post"
										...
										<div class="row">
											<div class="col-6">
												...
												<input type="text" class="form-control" id="setting-input-2"
													name="nom" value='<c:out value="${ auteur.nom }" />' required>
											</div>
											<div class="col-6">
												<label for="setting-input-2" class="form-label">Last name</label>
												<input type="text" class="form-control" id="setting-input-2"
													name="prenom" value='<c:out value="${ auteur.prenom }" />' required>
											</div>
											<input type="hidden" class="form-control" id="setting-input-2"
													name="id" value='<c:out value="${ auteur.id }" />' required>
										</div>
									</div>
									...
									<div class="mb-5">
										<div class="row">
											...
											<div class="col-12">
												<label for="setting-input-2" class="form-label">Nationality</label>
												<select class="form-select" name="nationalite">
													<option selected='<c:out value="${ auteur.nationalite }" />' value='<c:out value="${ auteur.nationalite }" />'><c:out value="${ auteur.nationalite }" /></option>
													<c:forEach var="nationalite" items="${ nationalites }">
													
													<option value='<c:out value="${ nationalite }" />'><c:out value="${ nationalite }" /></option>
											...
											<c:forEach var="auteur" items="${ auteurs }">
												<tr>
													...
													<td class="cell"><a class="btn-sm app-btn-secondary"
														href="<c:url value='edit_auteur?id=${auteur.id}'/>">Modifier</a>
													<td class="cell"><a class="btn-sm app-btn-secondary"
														href="<c:url value='delete_auteur?id=${auteur.id}'/>">Supprimer</a></td>
												</tr>
											</c:forEach>
    ...
    $(document).ready(function(){
        $("#editAuteur").modal('show');
        $('#btn-close').click(function () {
            /* when the submit button in the modal is clicked, submit the form */
            //alert('submitting');
            //$('#formfield').submit();
            window.location.href = "list_auteur";
        });
