			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link <c:out value='${actived}'/>" aria-current="page" href="list_document"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
							...
							</span> <span class="nav-link-text">Documents</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link <c:out value='${activeo}'/>" href="list_domain"> <span
								class="nav-icon"> <svg width="1em" height="1em"
									...
									</span> <span class="nav-link-text">Domains</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link <c:out value='${activea}'/>" href="list_auteur"> <span
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link <c:out value='${activem}'/>" href="list_maisonEdition"> <span
								class="nav-icon "> <svg width="1em" height="1em"
							...
							</span> <span class="nav-link-text">Publishing house</span>
						</a> <!--//nav-link-->
						</li>
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link <c:out value='${activet}'/>" href="list_type_document "> <span
								class="nav-icon"> <svg width="1em" height="1em"
										viewBox="0 0 16 16" class="bi bi-house-door"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
							...
							</span> <span class="nav-link-text">Types of document</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
					</ul>
