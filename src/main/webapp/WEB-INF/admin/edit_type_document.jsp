...
<body class="app">
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="modal fade" id="editTypeDocument"
					data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
					aria-labelledby="staticBackdropLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">Update Type of Document</h5>
										...
										<div class="row">
											<div class="col-12">
												<label for="setting-input-2" class="form-label">Designation
													...
													id="setting-input-2" name="designation" value='<c:out value="${ typeDocument.designation }" />' required>
											</div>	
											<input type="hidden" class="form-control"
													id="setting-input-2" name="id" value='<c:out value="${ typeDocument.id }" />' required>
										</div>
									</div>									
    ...
    $(document).ready(function(){
        $("#editTypeDocument").modal('show');
        $('#btn-close').click(function () {
            /* when the submit button in the modal is clicked, submit the form */
            //alert('submitting');
            //$('#formfield').submit();
            window.location.href = "list_type_document";
        });
