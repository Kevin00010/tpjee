...
<body class="app">
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="modal fade" id="editMaisonEdition"
					data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
					aria-labelledby="staticBackdropLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">Update publishing house</h5>
								<button type="button" class="btn-close" id="btn-close2" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<div class="modal-body">
								<form class="settings-form" method="post" action="update_maisonEdition">

									<div class="mb-3">
										<div class="row">
											<div class="col-12">
												<label for="setting-input-2" class="form-label">Publishing house name </label> 
													<input type="text" class="form-control"
													id="setting-input-2" name="nomMaison" value='<c:out value="${ maisonEdition.nomMaison }" />' required>
											</div>
											<input type="hidden" class="form-control"
													id="setting-input-2" name="id" value='<c:out value="${ maisonEdition.id }" />' required>
							...
							<div class="app-card-body">
								...
								<div class="card">
									<div class="card-header">
										<div class="col-auto">
											<h1 class="app-page-title mb-0">Publishing Houses</h1>
										</div>
									</div>
									<div class="card-body">
										<table id="example" class="stripe row-border"
											...
											<tbody>
												<c:forEach var="maisonEdition" items="${ maisonEditions }">
													<tr>
														<td><c:out value="${ maisonEdition.id }" /></td>
														<td><c:out value="${ maisonEdition.nomMaison }" /></td>

														<td class="cell"><a class="btn-sm "
															style="color: darkorange"
															href="<c:url value='edit_maisonEdition?id=${maisonEdition.id}'/>"><i
																class="material-icons" data-toggle="tooltip"
																title="Edit">&#xE254;</i></a> <a class="btn-sm "
															style="color: red"
															href="<c:url value='delete_maisonEdition?id=${maisonEdition.id}'/>"><span><i
																	class="material-icons" data-toggle="tooltip"
    ...
    $(document).ready(function(){
        $("#editMaisonEdition").modal('show');
        $('#btn-close').click(function () {
            /* when the submit button in the modal is clicked, submit the form */
            //alert('submitting');
            //$('#formfield').submit();
            window.location.href = "list_maisonEdition";
        });
