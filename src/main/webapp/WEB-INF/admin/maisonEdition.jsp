					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">Add Publishing house</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<div class="modal-body">
								<form class="settings-form" method="post" action="insert_maisonEdition">

									<div class="mb-3">
										<div class="row">
											<div class="col-12">
												<label for="setting-input-2" class="form-label"> Publishing house name
													</label> <input type="text" class="form-control"
													id="setting-input-2" name="nomMaison" required>
											</div>
