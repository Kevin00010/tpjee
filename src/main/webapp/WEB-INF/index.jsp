			...
			<div class="container-xl">
							...
							<div class="app-card app-card-stat shadow-sm h-100">
								<div class="app-card-body p-3 p-lg-4">
									<h4 class="stats-type mb-1">
										<c:out value="${ domain.designation }" />
									</h4>
								...
								<a class="app-card-link-mask"
									href='<c:url value='documents_domain?id=${domain.id}'/>'></a>
							</div>
							<!--//app-card-->
						</div>
						<!--//col-->
				...
				<div class=" row g-4 scrolling-wrapper mb-5">
					<c:forEach items="${ documentsByDomain.keySet() }" var="domain">
						<h5 class=" ">
							<c:out value="${ domain.getDesignation() }" />
						</h5>
						<hr class="text-primary h-100 p-0 m-0" style="height: 50px;">
						<c:forEach var="document" 	items="${ documentsByDomain.get(domain) }" begin="0" end="3" >
						
							<div class="col-6 col-md-4 col-xl-3  docs">
